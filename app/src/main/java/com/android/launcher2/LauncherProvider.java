...
public class LauncherProvider extends ContentProvider {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private Context mContext; // Standard variable

        DatabaseHelper(Context context) {
            super(context, DATABASE_NAME, null, DATABASE_VERSION);
            mContext = context; // Assign the variable
        ...
        private int loadFavorites(SQLiteDatabase db, long filterContainerId) {
            ...
            int i = 0;
            try {
                XmlResourceParser parser = getContext().getResources().getXml(R.xml.default_workspace);
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.Favorite);
                    ...
                    if (filterContainerId == ItemInfo.NO_ID || filterContainerId == container) {
                        ...
                        if (TAG_FAVORITE.equals(name)) {
                            ...
                            if (titleResId != -1) {
                                title = getContext().getResources().getString(titleResId);
                            } else {
                                title = getContext().getResources().getString(R.string.folder_name);
                            }
                            ...
                            while ((type = parser.next()) != XmlPullParser.END_TAG ||
                                ...
                                TypedArray ar = getContext().obtainStyledAttributes(attrs,
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            values.put(Favorites.ICON_PACKAGE, getContext().getPackageName());
