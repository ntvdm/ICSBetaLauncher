...
public class LauncherModel extends BroadcastReceiver {
    ...
    private class LoaderTask implements Runnable {
        // 1. Change this back to a variable (field)
        ...
        LoaderTask(Context context, boolean isLaunching) {
            // 2. Assign the parameter to the field, not a method
            mContext = context;
            mIsLaunching = isLaunching;
            mLabelCache = new HashMap<Object, CharSequence>();
        }

        // 3. Add a helper method so the rest of the code can still call getContext()
        ...
        public void dumpState() {
            Log.d(TAG, "mLoaderTask.getContext()=" + getContext());
